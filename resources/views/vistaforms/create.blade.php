    ...
    <div class="container">
        ...
        <form action="/forms" method="POST" enctype="multipar/form-data">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="dimensiones" placeholder="Tamaño que necesita (Opcional)">


            </div>
            <div class="form-group col-md-6">
                <label>Dimensiones de ejemplo (Opcional) </label>
                <select class="browser-default custom-select" name="dimensiones" placeholder="Dimensiones de ejemplo...">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="referencia" placeholder="Enlace a una referencia (Opcional)">
            </div>

            <div class="form-group col-md-6">
                <label>Tipo de dibujo</label>
                <input type="text" class="form-control" name="tipo" placeholder="Ej. Boceto, lineart... ">
            </div>
